var data = {
  ...
  "pageEvents": {
    ...
    "lishan-high-mountain-farms": {
      ...
      "videoText": ["近十多年來茶園、高麗菜園更是攻城掠地，一步步取代原本翠綠的山頭，根據統計，大梨山地區果樹與高冷蔬菜種植面積超過4000公頃(要換算)，產值達26億。", "土石向大甲溪滾落，表層崩塌之外還有深層隱憂。梨山處在中央山脈與雪山山脈之間，狹長的帶狀崩塌地，這樣的地質條件與小林村相似，有深層崩塌的地滑危機。\n\n1990年，梨山發生大規模滑動，每年出現5到10公分的變位，著名的梨山賓館也因此歇業。直到中興大學土木工程系蘇苗彬教授提出了一個控制地滑風險的排水計畫，以10億6800萬的經費在梨山賓館下方打出兩座排水隧道，每年排出100萬立方公尺的水（相當於666座標準游泳池的水量），來維持本區230公頃土地的安全。", "2018年我們的島再度來到梨山地區，新佳陽和松茂部落持續地滑中。", "梨山位於大甲溪上游德基水庫集水區，農業、道路等各種開發對水庫壽命造成威脅。德基水庫淤積量高達四成以上，有效庫容從？？剩下??，農業所使用的化肥、農藥對水庫水質也會產生影響。為了保護水庫集水區，政府在1993年公告「德基水庫集水區陡坡農用地(超限利用地)處理事宜」，計畫在四年內以補償方式，收回所有違規使用土地，然而該方案執行十多年成效不彰。直到2004年敏督利颱風重創大甲溪上游與梨山地區，在國土保育的強大呼聲下，林務局透過訴訟方式，強制收回超限利用的林班地，目前已收回三百多筆的超限利用地，收回比率達九成以上。"],
      // PhotoSwitch
    ...
    "lushan-hotspring-risk": {
      ...
      // PhotoFull
      "photoFullText": ["商機蓬勃卻違法營業\n\n好水好商機，吸引了大量業者聚集。因為發展蓬勃，1986年南投縣府劃設了廬山風景特定區都市計畫。然而，廬山地區腹地不大，沿著塔羅灣溪畔，擠進了四十多家溫泉飯店，只有五家位在都市計畫使用分區當中的商業區，完全合法，其餘的，有些位在住宅區、河川區等，大多數不符合土地使用分區規定，違法經營。", "廬山溫泉面對的自然風險，不只有風災與淹水，還有一項人力無法控制的威脅：潛在大規模崩塌（另開註解），目前已經引起多處道路邊坡、部份民宅以及廬山公有停車場產生裂隙，這些裂隙每年都在持續擴張。"],
